...
export const TermsContent = () => (
  <div className='content mobile terms'>
    <h3 className='terms__title'>Правила пользования</h3>
    <ol className='terms__descr'>
      <li className='terms__descr_main'>
        ...
        <ol>
          <li className='terms__descr_paragraf'>
